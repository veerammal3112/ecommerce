...
export default function ProductSearch() {
  ...
  useEffect(() => {
    ...
    dispatch(getProducts(keyword,priceChanged,category,rating,currentPage||1));
          ...
          <section id="products" className="container mt-5">
            <div className="row">
              <div className = "col-6 col-md-3 mb-5 mt-5">
                {/* to create Price filter tooltip */}
                ...
                <div className="mt-5">
                  ...
                  <ul className="pl-0">{categories.map(category =>
                ...
                <div className="mt-5">
                  ...
                  <ul className="pl-0">{[5,4,3,2,1].map(star =>
